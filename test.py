...
print("Creating TomeRaterNovel: The isbn 123909 already exists for another book. Please give a unique isbn.")
tomeraternovel2 = tomerater1.create_novel("Untruthed", 123909, "Jim Crowing", 9)
print("Creating TomerRaterNon_Fiction: The isbn 111999 already exists for another book. Please give a unique isbn.")
tomeraternon_fiction2 = tomerater1.create_non_fiction("Python is Dummies", 111999, "Change", "Test", 29)
