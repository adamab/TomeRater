...
print("Testing user1 string representation: User Beatriz Rodriguez with email Bella@last.org has read 0 book(s) with an average rating of None")
print(user1)
print("Testing equality of user1 and user2: False")
print(user1 == user2)
print("Testing equality of user1 and user3: True")
print(user1 == user3)
print("Testing get_email user1: Bella@last.org")
...
print(user3.get_books_read(), user3.books)
...
print("Testing set_isbn book4: 123809 to 123555")
...
tomerater2.add_book_to_user(fiction4, "Bella@last.org", 2.5)
tomerater2.add_book_to_user(fiction4, "li@test.edu", 3)
tomerater2.add_book_to_user(tomeraternovel1, "Bella@last.org", 4)
...
print(tomerater3.get_worth_of_user("li@test.edu"))
...
print("Creating TomeRaterNovel: The isbn 122345 already exists for another book. Please give a unique isbn.")
tomerater1.add_book_to_user(tomeraternovel1, "Bella@last.org")
tomeraternovel2 = tomerater1.create_novel("Untruthed", "Jim Crowing", 122345, 9)
print("Creating TomerRaterNon_Fiction: The isbn 111999 already exists for another book. Please give a unique isbn.")
tomerater1.add_book_to_user(tomeraternon_fiction1, "Bella@last.org")
tomeraternon_fiction2 = tomerater1.create_non_fiction("Python is Dummies", "Change", "Test", 111999, 29)
print("Testing incorrect email error handling for user3 tomerater3: The email jenny.from#theblock.org is invalid, please ensure it has an @ and a .com, .edu, or .org domain.")
tomerater3.add_user("Jenny Parqua", "jenny.from#theblock.org")
print("Testing incorrect email handling for user3 tomerater3: The email jenny.from@the.block is invalid, please ensure it has an @ and a .com, .edu, or .org domain.")
tomerater3.add_user("Jenny Parqua", "jenny.from@the.block")
